...
func (api *Client) DeleteChannel(channelName string) (*Channel, error) {
...
func (api *Client) DeleteChannelContext(ctx context.Context, channelName string) (*Channel, error) {
	values := url.Values{
		"token": {api.token},
		"name":  {channelName},
	}
